...
const Search = () => {
  ...
  const genres = [
    ...
    { name: 'Rock', color: '#6C5CE7', icon: <Headphones size={24} />, gradient: 'linear-gradient(45deg, #6C5CE7, #a363d9)' },
    { name: 'Ballad', color: '#FF8ED4', icon: <Heart size={24} />, gradient: 'linear-gradient(45deg, #FF8ED4, #FF6B6B)' },
    { name: 'Rap', color: '#E17055', icon: <Mic2 size={24} />, gradient: 'linear-gradient(45deg, #E17055, #FAB1A0)' },
    { name: 'EDM', color: '#1DD1A1', icon: <Star size={24} />, gradient: 'linear-gradient(45deg, #1DD1A1, #00B894)' },
    { name: 'K-pop', color: '#00B894', icon: <Disc size={24} />, gradient: 'linear-gradient(45deg, #00B894, #00CEC9)' },
