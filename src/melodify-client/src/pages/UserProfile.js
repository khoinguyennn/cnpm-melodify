...
const UserProfile = () => {
    ...
    return (
      <div className="d-flex min-vh-100" style={{ backgroundColor: "#18122B", color: "white" }}>
        ...
        <div className="flex-grow-1 profile-main-content" style={{
                  ...
                  <div>
                    ...
                    <div className="card bg-dark mb-4">
                      <div className="card-body">
                        ...
                        <div className="form-check form-switch mb-3">
                          <input className="form-check-input" type="checkbox" id="profilePublic" checked />
                          <label className="form-check-label" htmlFor="profilePublic">
                            Make my profile public
                          </label>
                        </div>
                        <div className="form-check form-switch mb-3">
                          <input className="form-check-input" type="checkbox" id="showActivity" checked />
                          <label className="form-check-label" htmlFor="showActivity">
                            Show my listening activity
                          </label>
                        </div>
                        <div className="form-check form-switch">
                          <input className="form-check-input" type="checkbox" id="showPlaylists" checked />
                          <label className="form-check-label" htmlFor="showPlaylists">
                    ...
                    <div className="card bg-dark">
                      <div className="card-body">
                        ...
                        <p className="card-text">Manage your personal data and privacy settings</p>
                        <button className="btn btn-outline-primary mb-2">Download Your Data</button>
